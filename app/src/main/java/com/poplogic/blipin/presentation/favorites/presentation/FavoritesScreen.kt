...
import com.poplogic.blipin.presentation.favorites.presentation.screens.FavoritesPageSuccessAnonymousScreen
import com.poplogic.blipin.presentation.favorites.presentation.screens.FavoritesPageSuccessEmptyScreen
import com.poplogic.blipin.presentation.favorites.presentation.screens.FavoritesPageSuccessScreen
        ...
        when (val state = uiState.value) {
            ...
            is FavoritesUiState.Success -> {
                ...
                if (state.favorites.isEmpty()) {
                    FavoritesPageSuccessEmptyScreen(
                        modifier = Modifier.weight(1f),
                        homeNavigationController = homeNavigationController,
                    )
                } else {
                    FavoritesPageSuccessScreen(
                        modifier = Modifier.weight(1f),
                        homeNavigationController = homeNavigationController,
                    )
                }
