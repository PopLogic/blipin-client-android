package com.poplogic.blipin.presentation.home.presentation
...
import com.poplogic.blipin.feature.common.background.Background
import com.poplogic.blipin.feature.common.theme.BlipinBlack
import com.poplogic.blipin.feature.common.theme.BlipinBrandPrimary
import com.poplogic.blipin.feature.common.theme.BlipinNeutral50
import com.poplogic.blipin.feature.common.theme.BlipinPrimary100
import com.poplogic.blipin.feature.common.theme.Typography
import com.poplogic.blipin.presentation.home.nav.HomeNavHost
                                    ...
                                    coroutineScope.launch {
                                        when (homepage) {
                                            HomePageTabs.Explore -> {
                                                exploreListState.animateScrollToItem(
                                                    0,
                                                )
                                            }

                                            HomePageTabs.Favorites -> {
                                                favoritesScrollState.animateScrollTo(
                                                    0,
                                                )
                                            }

                                            HomePageTabs.Profile -> {
                                                profileScrollState.animateScrollTo(
                                                    0,
                                                )
                                            }
                                        }
